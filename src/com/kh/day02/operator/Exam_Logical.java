...
public class Exam_Logical {
	public static void main(String [] args)
	{
		...
		int num1 = 50;
		int num2 = 30;
		boolean result1, result2, result3, result4;    //같은 연산자면 ,로 가능
		// 남자이면서 평균평점 4.3 이상인 사람
		// 컴퓨터공학과 또는 경영학과인 사람   ~이면서 = && 또는 or(||)
		...
		// 			false			true
		// aNum : 71, bNum : 55, result : false      -- && 앞에가 false라 뒤에 동작이 되지않음.
		// &&의 경우 앞이 false면 뒤는 계산 x
		System.out.println("aNum의 값 : " + aNum + ", bNum의 값 : " + bNum);
		...
		//			true			
		// aNum : 73, bNum : 54, result4 : true      -- || 앞이 true라 뒤에 동작이 되지않음.
		// ||의 경우 앞이 true면 뒤는 계산 x
		System.out.println("aNum의 값 : " + aNum + ", bNum의 값 : " + bNum);
