...
public class Exam_SelecSort {

	public static void main(String[] args) {
		// 선택정렬이란?
		// 배열울 전부 검색하여 최소값을 고르고 왼쪽부터 채워나가는 정렬 알고리즘.
		...
		// 1. 최소값의 값을 구하는 방법으로
		// 2. 배열의 값을 교환
		// 3. min값은 최솟값이 아니라 인덱스값을 저장해야함.
		// 4. 최소값을 찾는 범위가 시작은 1이 되고 1씩 증가해야했었고
		// 바꿔야 하는 자리는 0부터 시작해서 1씩 증가해야했음.
		// 5. 만족하는 변수를 선언하여 1씩 증가라는 for문 작성 후 코드를 이동
		int[] arrs = { 2, 5, 4, 1, 3 };
		int min = 0; // min은 최솟값 저장하면 안되고 최소인 인덱스값을 저장해야함.
